...
pub enum SinkState {
    ...
    /// The sink is being initialized and is not yet stable.
    Init,

    /// The sink has been unlinked and is leaving the server.
    Unlinked,
    ...
    /// An unrecognized state supplied by the server.
    Unknown(c_int),
}

/// Check conversion from the C API equivalent.
#[test]
fn sink_state_compare_capi() {
    assert_eq!(SinkState::Invalid,   SinkState::from(capi::pa_sink_state_t::Invalid));
    assert_eq!(SinkState::Init,      SinkState::from(capi::pa_sink_state_t::Init));
    assert_eq!(SinkState::Unlinked,  SinkState::from(capi::pa_sink_state_t::Unlinked));
    ...
    assert_eq!(SinkState::Unknown(-99), SinkState::from(capi::pa_sink_state_t::from_raw(-99)));
}
...
impl From<SinkState> for capi::pa_sink_state_t {
    ...
    fn from(s: SinkState) -> Self {
        match s {
            SinkState::Invalid => capi::pa_sink_state_t::Invalid,
            SinkState::Init => capi::pa_sink_state_t::Init,
            SinkState::Unlinked => capi::pa_sink_state_t::Unlinked,
            SinkState::Running => capi::pa_sink_state_t::Running,
            SinkState::Idle => capi::pa_sink_state_t::Idle,
            SinkState::Suspended => capi::pa_sink_state_t::Suspended,
            SinkState::Unknown(value) => capi::pa_sink_state_t::from_raw(value),
        }
    }
}
...
pub enum SourceState {
    ...
    /// The source is being initialized and is not yet stable.
    Init,

    /// The source has been unlinked and is leaving the server.
    Unlinked,
...
fn source_state_compare_capi() {
    ...
    assert_eq!(SourceState::Init,      SourceState::from(capi::pa_source_state_t::Init));
    assert_eq!(SourceState::Unlinked,  SourceState::from(capi::pa_source_state_t::Unlinked));
    ...
    assert_eq!(SourceState::Unknown(-99), SourceState::from(capi::pa_source_state_t::from_raw(-99)));
}
...
impl From<SourceState> for capi::pa_source_state_t {
    ...
    fn from(s: SourceState) -> Self {
        match s {
            SourceState::Invalid => capi::pa_source_state_t::Invalid,
            SourceState::Init => capi::pa_source_state_t::Init,
            SourceState::Unlinked => capi::pa_source_state_t::Unlinked,
            SourceState::Running => capi::pa_source_state_t::Running,
            SourceState::Idle => capi::pa_source_state_t::Idle,
            SourceState::Suspended => capi::pa_source_state_t::Suspended,
            SourceState::Unknown(value) => capi::pa_source_state_t::from_raw(value),
        }
    }
}
impl From<capi::pa_source_state_t> for SourceState {
    ...
    fn from(s: capi::pa_source_state_t) -> Self {
        match s.raw() {
            -3 => SourceState::Unlinked,
            -2 => SourceState::Init,
            -1 => SourceState::Invalid,
            0 => SourceState::Running,
            1 => SourceState::Idle,
            2 => SourceState::Suspended,
            value => SourceState::Unknown(value),
        }
    }
}
